//
//  RG_MA_WithdrawViewController.m
//  DigGold
//
...
@interface RG_MA_WithdrawViewController ()
<UITableViewDelegate,
...
@implementation RG_MA_WithdrawViewController
...
- (void)fetchData {
    ...
    [[WLHttpManager shareManager]requestWithURL_HTTPCode:Port_TixianList_URL RequestType:RequestTypePost Parameters:params Success:^(NSInteger statusCode, id responseObject) {
...
//                [RCHUDPop popupTipText:responseObject[@"msg"] toView:nil];
            ...
            NSArray *newArray = [RG_MAWithdrawModel mj_objectArrayWithKeyValuesArray:netWorkModel.data[@"list"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    RG_MA_WdRecordTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    RG_MAWithdrawModel *model = self.dataArray[indexPath.row];
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[RG_MA_WdRecordTableViewCell class] forCellReuseIdentifier:@"cell"];

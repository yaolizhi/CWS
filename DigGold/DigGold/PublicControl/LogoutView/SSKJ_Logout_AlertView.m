...
{
    if (nil == _titleLabel) {
        _titleLabel = [WLTools allocLabel:@"退出登录" font:systemFont(ScaleW(15)) textColor:[UIColor whiteColor] frame:CGRectMake(ScaleW(15), ScaleW(37), self.showView.width - ScaleW(30), ScaleW(15)) textAlignment:NSTextAlignmentCenter];
    }
    return _titleLabel;
}
...
-(UILabel *)messageLabel
{
    if (nil == _messageLabel) {
        _messageLabel = [WLTools allocLabel:@"" font:systemFont(ScaleW(12)) textColor:[UIColor whiteColor] frame:CGRectMake(ScaleW(15), self.titleLabel.bottom + ScaleW(23), self.showView.width - ScaleW(30), ScaleW(30)) textAlignment:NSTextAlignmentCenter];
    }
...
-(UIButton *)confirmButton
{
    if (nil == _confirmButton) {
        ...
        [_confirmButton setTitleColor:kMainTitleColor forState:UIControlStateNormal];
